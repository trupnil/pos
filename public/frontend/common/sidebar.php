  ...
  <li>
    <ul class="collapsible">
     <li class="small-cap"><span class="hide-menu">Accounts</span></li>
      <li>
       <li>
        <a href="javascript: void(0);" class=""><i class="material-icons">dashboard</i><span class="hide-menu"> Dashboard</span></a>
        
      </li>

      <li>
        <a href="javascript: void(0);" class=""><i class="material-icons">dashboard</i><span class="hide-menu"> Users</span></a>
       ...
       <li>
        ...
        <div class="collapsible-body">
          <ul>
            <li><a href="list_account_group.php"><i class="material-icons">adjust</i><span class="hide-menu">Account Group</span></a></li>
            <li><a href="list_account.php"><i class="material-icons">adjust</i><span class="hide-menu">Account</span></a></li>
            <li><a href="list_customer_group.php"><i class="material-icons">adjust</i><span class="hide-menu">Customers Group</span></a></li>
            <li><a href="customers.php"><i class="material-icons">adjust</i><span class="hide-menu">Customers</span></a></li>
            <li><a href="list_supplier_group.php"><i class="material-icons">adjust</i><span class="hide-menu">Supplier Group</span></a></li>
            <li><a href="list_supplier.php"><i class="material-icons">adjust</i><span class="hide-menu">Suppliers</span></a></li>
